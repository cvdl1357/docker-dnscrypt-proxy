...
RUN git clone --depth 1 https://github.com/DNSCrypt/dnscrypt-proxy.git /src/dnscrypt-proxy
WORKDIR /src/dnscrypt-proxy/dnscrypt-proxy

# Force update dependencies and build the binary in the source folder
